...
export default function DialogAddFolder({
  open,
  onClose,
  folderParent,
  type,
  ...
  const validationSchema = yup.object({
    name: yup
      .string('Entrez le nom de dossier')
  ...
  const handleOk = (folderForm) => {
    ...
    if (folderToEdit)
      updateFolder({ variables: { id: folderToEdit.id, folderData } });
    ...
    if (open) {
      ...
      if (folderToEdit) {
        formik.setValues({
          ...
          observation: folderToEdit.observation,
