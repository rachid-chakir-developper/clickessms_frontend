...
import { Alert, Avatar, Chip, MenuItem, Popover, Stack, TablePagination } from '@mui/material';
...
const headCells = [
    {
      ...
      exportField: 'letter_type',
      numeric: false,
      disablePadding: true,
      isDefault: true,
      label: "Type de courrier",
      render: ({letterType}) => getLetterTypeLabel(letterType),
    },
    {
      id: 'title',
      property: 'title',
    ...
    {
      id: 'sender',
      property: 'sender__name',
      exportField: ['sender__name'],
      numeric: false,
      disablePadding: true,
      isDefault: true,
      label: "Qui a envoyé ?",
...
export default function TableListLetters({
  loading,
  rows,
  onDeleteLetter,
  onFilterChange,
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar 
          ...
          onFilterChange={(selectedColumns)=>setSelectedColumns(selectedColumns)}
        />
        <TableContainer>
          <Table
            sx={{ minWidth: 750 }}
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/administratif/courriers/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/administratif/courriers/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/administratif/courriers/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
