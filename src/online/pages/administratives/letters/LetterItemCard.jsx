...
export default function LetterItemCard({letter, onDeleteLetter, onUpdateLetterState}) {
      ...
      <Stack direction="column" spacing={2} alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Tooltip title="Modifier">
            <Link to={`/online/administratif/courriers/modifier/${letter?.id}`} className="no_style">
          ...
          <Tooltip title="Détails">
            <Link to={`/online/administratif/courriers/details/${letter?.id}`} className="no_style">
              <IconButton aria-label="edit" size="small">
