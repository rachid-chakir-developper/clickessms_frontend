              ...
              {visibleRows?.map((row, index) => {
                ...
                return (
                  <StyledTableRow
                    ...
                    sx={{ cursor: 'pointer' }}
                    onClick={() => navigate(`/online/administratif/reunions/details/${row.id}`)}
                  >
                    <StyledTableCell padding="checkbox">
                      <Checkbox
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/administratif/reunions/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/administratif/reunions/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
