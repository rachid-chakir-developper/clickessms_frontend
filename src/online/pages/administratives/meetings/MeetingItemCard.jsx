  ...
  return (
    <Card variant="outlined" sx={{ p: 1, display: 'flex', alignItems: 'center', gap: 2, }}>
      <Tooltip title={meeting?.title}>
        <CardMedia component="img" width="100" height="100" alt={meeting?.title}
          src={ meeting?.image ? meeting?.image : "https://mui.com/static/images/cards/real-estate.png"}
      ...
      <Stack direction="column" spacing={2} alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Tooltip title="Modifier">
            <Link to={`/online/administratif/reunions/modifier/${meeting?.id}`} className="no_style">
              <IconButton aria-label="edit" size="small">
                <Edit fontSize="small" />
              </IconButton>
            </Link>
          </Tooltip>
          {meeting?.folder && <Tooltip title="Pièces jointes">
          ...
          <Tooltip title="Détails">
            <Link to={`/online/administratif/reunions/details/${meeting?.id}`} className="no_style">
              <IconButton aria-label="edit" size="small">
