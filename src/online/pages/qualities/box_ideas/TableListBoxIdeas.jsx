...
export default function TableListBoxIdeas({
  loading,
  rows,
  onDeleteBoxIdea,
  onFilterChange,
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/qualites/boite-idees/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/qualites/boite-idees/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/qualites/boite-idees/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
