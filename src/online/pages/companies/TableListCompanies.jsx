...
import CompanyStatusLabelMenu from './CompanyStatusLabelMenu';
...
export default function TableListCompanies({
  loading,
  rows,
  onDeleteCompany,
          ...
          >
            ...
            <TableBody>
              ...
              {rows?.length < 1 && !loading && (
                <StyledTableRow>
                  <StyledTableCell colSpan="9">
                    <Alert severity="warning">Aucune association trouvé.</Alert>
                  </StyledTableCell>
                </StyledTableRow>
              )}
                ...
                return (
                  ...
                  >
                    ...
                    <StyledTableCell align="left">
                      <CompanyStatusLabelMenu company={row} />
                    </StyledTableCell>
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/associations/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/associations/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
