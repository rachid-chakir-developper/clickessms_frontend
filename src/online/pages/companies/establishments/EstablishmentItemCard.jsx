      ...
      <Stack direction="column" spacing={2} alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          { establishment?.establishmentParent && <Tooltip title={`L'éstablishment parent: ${establishment?.establishmentParent?.name}`}>
            <Link to={`/online/associations/etablissements/details/${establishment?.establishmentParent?.id}`} className="no_style">
          ...
          <Tooltip title="Modifier">
            <Link to={`/online/associations/etablissements/modifier/${establishment?.id}`} className="no_style">
          ...
          <Tooltip title="Détails">
            <Link to={`/online/associations/etablissements/details/${establishment?.id}`} className="no_style">
              <IconButton aria-label="edit" size="small">
