    ...
    return (
      <div className="online">
          <Routes>
                  ...
                  <Route path={`modifier/:idEstablishmentService`} element={<AddEstablishmentService />} />
                  <Route path={`details/:idEstablishmentService`} element={<EstablishmentServiceDetails />} />
                  <Route
                      path="/"
