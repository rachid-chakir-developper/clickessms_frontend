...
import { POST_SUPPLIER, PUT_SUPPLIER } from '../../../../_shared/graphql/mutations/SupplierMutations';
...
export default function AddSupplierForm({ idSupplier, title}) {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            iban : '' , bic : '' , bankName : '' ,
            isActive : true , description : '' , observation : '' , supplierType : 'INDIVIDUAL'
          },
    ...
    const [createSupplier, { loading : loadingPost }] = useMutation(POST_SUPPLIER, {
        onCompleted: (data) => {
            console.log(data);
            setNotifyAlert({
                isOpen: true,
              ...
              fields: {
                suppliers(existingSuppliers = { totalCount: 0, nodes: [] }, { readField }) {
                    ...
                    const updatedSuppliers = existingSuppliers.nodes.map((supplier) =>
                        readField('id', supplier) === updatedSupplier.id ? updatedSupplier : supplier
                    );
    ...
    const [getSupplier, { loading : loadingSupplier }] = useLazyQuery(GET_SUPPLIER, {
                    ...
                    <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                            ...
                            <Item>
                                <FormControl fullWidth>
                                    ...
                                    <Select
                                        ...
                                        onChange={(e) => formik.setFieldValue('supplierType', e.target.value)}
                                        disabled={loadingPost || loadingPut}
                                    >
                        ...
                        <Grid xs={12} sm={12} md={12}>
                            <Item sx={{ justifyContent: 'end', flexDirection : 'row' }}>
                                <Link to="/online/achats/fournisseurs/liste" className="no_style">
