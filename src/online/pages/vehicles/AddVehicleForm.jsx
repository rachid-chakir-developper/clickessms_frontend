            ...
            <Grid xs={2} sm={2} md={2}>
              <Item>
                <TheSwitch
                  ...
                  onChange={(e) =>
                    formik.setFieldValue('isInService', e.target.checked)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={2} md={2}>
              <Item>
                <TheSwitch
                  ...
                  onChange={(e) =>
                    formik.setFieldValue('isOutOfOrder', e.target.checked)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={2} md={2}>
              <Item>
                <TheSwitch
                  ...
                  onChange={(e) =>
                    formik.setFieldValue('isRented', e.target.checked)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={2} md={2}>
              <Item>
                <TheSwitch
                  ...
                  onChange={(e) =>
                    formik.setFieldValue('isBought', e.target.checked)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
