...
export default function VehicleItemCard({vehicle, onDeleteVehicle, onUpdateVehicleState}) {
      ...
      <Stack direction="column" spacing={2} alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Tooltip title="Modifier">
            <Link to={`/online/vehicules/modifier/${vehicle?.id}`} className="no_style">
              <IconButton aria-label="edit" size="small">
                <Edit fontSize="small" />
              </IconButton>
            </Link>
          </Tooltip>
          {vehicle?.folder && <Tooltip title="Pièces jointes">
