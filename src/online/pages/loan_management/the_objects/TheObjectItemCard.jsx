...
export default function TheObjectItemCard({
  theObject,
  onDeleteTheObject,
  onUpdateTheObjectState,
}) {
      ...
      <Stack direction="column" spacing={2} alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Tooltip title="Modifier">
            <Link
              to={`/online/recuperations/objets/modifier/${theObject?.id}`}
              className="no_style"
            >
          ...
          <Tooltip title="Détails">
            <Link
              to={`/online/recuperations/objets/details/${theObject?.id}`}
              className="no_style"
            >
              <IconButton aria-label="edit" size="small">
