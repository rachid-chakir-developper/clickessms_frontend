...
import { GET_GROUPS, GET_PERMISSIONS, GET_USER } from '../../../_shared/graphql/queries/UserQueries';
import { POST_USER, PUT_USER } from '../../../_shared/graphql/mutations/UserMutations';
...
export default function AddUserForm({ idUser, title}) {
    ...
    const validationSchema = yup.object({
        username: yup .string('Entrez votre username').required(`L'username est obligatoire`),
        lastName: yup .string('Entrez votre nom').required('Le nom est obligatoire'),
        lastName: yup .string('Entrez votre nom').required('Le nom est obligatoire'),
        email: yup.string('Entrez votre email').email('Entrez un email valide').required(`L'email est obligatoire`),
      });
    const formik = useFormik({
        initialValues: {
            photo : undefined, coverImage : undefined , firstName : '', lastName : '', employee: null,
            email  : '', username : '' , description : '', observation : '', 
        },
                ...
                <form onSubmit={formik.handleSubmit}>
                    <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                        ...
                        <Grid xs={2} sm={4} md={4}>
                            ...
                            <Item>
                                <TheAutocomplete options={employeesData?.employees?.nodes} label="Employé"
                        ...
                        <Grid xs={2} sm={4} md={4}>
                            <Item>
                                <TheTextField variant="outlined" label="username" id="username"
                            ...
                            <Item>
                                <TheTextField variant="outlined" label="E-mail" id="email"
                        ...
                        <Grid xs={12} sm={12} md={6}>
                            ...
                            right={userPermissions} setRight={setUserPermissions}
                            title="Permissions"/>
                        </Grid>
                        <Grid xs={12} sm={12} md={6}>
                            <TransferList left={groups} setLeft={setGroups}
                                          right={userGroups} setRight={setUserGroups}
                                          title="Groups"/>
                        </Grid>
                        <Grid xs={12} sm={12} md={12}>
                            <Divider variant="middle" />
