...
export default function Profile() {
  ...
  return <Stack>{user && <ProfileDetailsPage user={user} />}</Stack>;
}
              ...
              <form onSubmit={formik.handleSubmit}>
                <Grid container>
                  ...
                  <Grid item xs={12} sm={12} md={12}>
                    ...
                    {passwordChangeData?.passwordChange?.errors?.newPassword1?.map(
                      (error, index) => (
                        <Alert key={index} severity="error">
                          {error?.message}
                        </Alert>
                    ...
                    {passwordChangeData?.passwordChange?.errors?.newPassword2?.map(
                      (error, index) => (
                        <Alert key={index} severity="error">
                          {error?.message}
                        </Alert>
                    ...
                    {passwordChangeData?.passwordChange?.errors?.nonFieldErrors?.map(
                      (error, index) => (
                        <Alert key={index} severity="error">
                          {error?.message}
                        </Alert>
