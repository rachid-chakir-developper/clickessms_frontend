...
export default function TableListSpaceRooms({
  loading,
  rows,
  onDeleteSpaceRoom,
  onFilterChange,
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/batiment-immobilier/salles/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/batiment-immobilier/salles/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/batiment-immobilier/salles/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
