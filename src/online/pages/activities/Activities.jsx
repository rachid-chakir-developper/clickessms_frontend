...
import BeneficiaryDocumentRecords from './document-records/BeneficiaryDocumentRecords';
  ...
  return (
    <Box>
      <Routes>
        ...
        <Route path={`documents-beneficiaires/*`} element={<BeneficiaryDocumentRecords />} />
