...
export default function TableListBeneficiaryExpenses({
  loading,
  rows,
  onDeleteBeneficiaryExpense,
  onFilterChange,
  paginator,
}) {
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/activites/depenses/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/activites/depenses/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/activites/depenses/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
                        ...
                        <MenuItem
                          onClick={() => {
                            onDeleteBeneficiaryExpense(row?.id);
                            handleCloseMenu();
                          }}
                          sx={{ color: 'error.main' }}
                        >
