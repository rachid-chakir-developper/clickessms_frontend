...
const VehicleTechnicalInspectionFilter = ({ onFilterChange }) => {
  ...
  const [selectedVehicles, setFilterSelectedVehicles] = useState([])
            ...
            <Item>
                <TheAutocomplete
                        ...
                        onChange={(event, newValue) => {
                            setFilterSelectedVehicles(newValue)
                            setFilterValues({ ...filterValues, vehicles: newValue.map((v) => v.id) })
                        }}
                      />
            </Item>
        </Grid>
...
export default VehicleTechnicalInspectionFilter;