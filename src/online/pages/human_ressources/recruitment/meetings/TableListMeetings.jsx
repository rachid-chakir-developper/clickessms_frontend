...
const headCells = [
    ...
    {
        id: 'jobCandidate',
        property: 'job_candidate__first_name',
        exportField: ['job_candidate__first_name', 'job_candidate__last_name'],
        numeric: false,
        disablePadding: false,
        isDefault: true,
        disableClickDetail: true,
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/ressources-humaines/recrutement/entretiens/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/ressources-humaines/recrutement/entretiens/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/ressources-humaines/recrutement/entretiens/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
