              ...
              {visibleRows?.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <StyledTableCell align="left">{`${getFormatDate(currentContract?.startingDate)}`}</StyledTableCell>
                    <StyledTableCell align="left">{`${getFormatDate(currentContract?.endingDate)}`}</StyledTableCell>
