...
const BeneficiaryAdmissionFilter = ({ onFilterChange }) => {
  ...
  const LIST_TYPES_ITEMS = {
    MY_BENEFICIARY_ADMISSIONS : 'MY_BENEFICIARY_ADMISSIONS',
    MY_BENEFICIARY_ADMISSION_REQUESTS : 'MY_BENEFICIARY_ADMISSION_REQUESTS',
    ALL : 'ALL',
    ALL_: [
      {value: 'ALL', label: 'Tous', hidden: false},
      {value: 'MY_BENEFICIARY_ADMISSIONS', label: 'Mes admissions', hidden: false},
      {value: 'MY_BENEFICIARY_ADMISSION_REQUESTS', label: 'Mes demandes', hidden: true},
    ]
  }
        ...
        <Grid item xs={12} sm={6} md={2}>
            <Item>
                <Autocomplete
                    ...
                    options={BENEFICIARY_ADMISSION_STATUS_CHOICES?.ALL}
...
export default BeneficiaryAdmissionFilter;