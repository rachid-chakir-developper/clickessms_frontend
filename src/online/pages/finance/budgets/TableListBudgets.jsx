...
const headCells = [
    ...
    },
    {
        ...
        isDefault: true,
        label: 'Année',
        render: ({startingDate}) => getFormatDate(startingDate, 'YYYY')
    },
    {
        id: 'amountAllocated',
    ...
    },
    {
        ...
        disableClickDetail: true,
        label: 'Status',
        render: (data)=> <BudgetStatusLabelMenu budget={data} />
    },
    {
        id: 'description',
...
export default function TableListBudgets({
  loading,
  rows,
  onDeleteBudget,
  onFilterChange,
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/finance/budgets/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/finance/budgets/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/finance/budgets/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
