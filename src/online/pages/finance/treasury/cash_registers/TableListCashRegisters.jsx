...
const headCells = [
    ...
    {
        id: 'managers',
        property: 'managers__employee__first_name',
        exportField: ['managers__employee__first_name', 'managers__employee__last_name'],
        numeric: false,
        disablePadding: false,
        isDefault: true,
        disableClickDetail: true,
        sortDisabled: true,
        label: 'Responsable(s)',
        render: ({managers}) => managers && managers?.length > 0 && <Stack direction="row" flexWrap='wrap' spacing={1}>
          <ChipGroupWithPopover people={managers?.map((manager)=>manager.employee)} />
      </Stack>
    },
    {
        id: 'openingDate',
        property: 'opening_date_time',
        exportField: 'opening_date_time',
        numeric: false,
        disablePadding: false,
        label: "Date d'ouverture",
        render: ({openingDate})=> getFormatDate(openingDate)
    },
    {
        id: 'closingDate',
        property: 'closing_date_time',
        exportField: 'closing_date_time',
        numeric: false,
        disablePadding: false,
        label: 'Date de fermeture',
        render: ({closingDate})=> getFormatDate(closingDate)
    },
    {
        id: 'balance',
        property: 'balance',
        ...
        isDefault: true,
        label: 'Solde',
        render: ({balance})=> <b>{balance ? formatCurrencyAmount(balance) : ''}</b>
    },
    {
        id: 'description',
...
export default function TableListCashRegisters({
  loading,
  rows,
                ...
                return (
                  ...
                  >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/finance/tresorerie/caisses/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        {canManageFinance && <><Link
                          to={`/online/finance/tresorerie/caisses/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
