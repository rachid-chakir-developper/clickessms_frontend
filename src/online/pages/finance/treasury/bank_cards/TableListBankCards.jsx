...
const headCells = [
    {
      ...
      isDefault: true,
      label: 'Image',
      render: ({image, name})=> <Avatar alt={`${name}`} variant="rounded" src={ image ? image : '/default-placeholder.jpg'}
    ...
    {
        id: 'establishment',
        property: 'bank_account__establishment__name',
        exportField: ['bank_account__establishment__name'],
        numeric: false,
        disablePadding: false,
        isDefault: true,
        ...
        sortDisabled: true,
        label: 'Structure',
        render: ({bankAccount}) => bankAccount?.establishment && <EstablishmentChip establishment={bankAccount?.establishment}/>
    },
    {
        id: 'bank_account',
        ...
        render: ({bankAccount}) => bankAccount && <BankAccountChip bankAccount={bankAccount}/>
    },
    {
        id: 'description',
...
export default function TableListBankCards({
  loading,
  rows,
  onDeleteBankCard,
  onFilterChange,
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/finance/tresorerie/cartes-bancaires/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/finance/tresorerie/cartes-bancaires/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/finance/tresorerie/cartes-bancaires/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
