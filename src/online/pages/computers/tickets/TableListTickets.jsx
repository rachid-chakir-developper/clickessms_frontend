...
import TaskActionStatusLabelMenu from '../../works/actions/TaskActionStatusLabelMenu';
                  ...
                  <React.Fragment key={row.id}>
                    ...
                    <StyledTableCell padding="checkbox">
                    ...
                    </StyledTableCell>
                      {
                        selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                          return <StyledTableCell
                            ...
                            key={index}
                            onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/informatique/tickets/details/${row?.id}`)}}
                          >
                      ...
                      <StyledTableCell align="right">
                        ...
                        >
                          <Link
                            to={`/online/informatique/tickets/details/${row?.id}`}
                            className="no_style"
                          >
                          ...
                          <Link
                            to={`/online/informatique/tickets/modifier/${row?.id}`}
                            className="no_style"
                          >
                            <MenuItem onClick={handleCloseMenu}>
                              <Edit sx={{ mr: 2 }} />
