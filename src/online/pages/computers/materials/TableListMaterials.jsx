...
const headCells = [
    ...
    {
        id: 'buyingPriceHt',
        property: 'buying_price_ht',
        exportField: 'buying_price_ht',
        numeric: false,
        disablePadding: false,
        isDefault: true,
        label: "Prix d'achat HT d'unité",
        render: ({buyingPriceHt})=> formatCurrencyAmount(buyingPriceHt)
    },
    {
        id: 'description',
...
export default function TableListMaterials({
  loading,
  rows,
  onDeleteMaterial,
  onFilterChange,
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/informatique/materiels/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/informatique/materiels/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/informatique/materiels/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
