...
import { GET_RECAP_MATERIAL } from '../../../../_shared/graphql/queries/MaterialQueries';
...
export default function MaterialDetails() {
  ...
  const [
    getMaterial,
    { loading: loadingMaterial, data: materialData },
  ] = useLazyQuery(GET_RECAP_MATERIAL);
  ...
  return (
    <Stack>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', my: 1 }}>
        <Link
          to="/online/informatique/materiels/liste"
          className="no_style"
        >
        ...
        <Link
          to={`/online/informatique/materiels/modifier/${materialData?.material?.id}`}
          className="no_style"
        >
...
const MaterialDetailsPage = ({ material }) => {
  const {
    id,
    number,
    name,
