...
export default function TableListSoftwares({
  loading,
  rows,
  onDeleteSoftware,
  onFilterChange,
                ...
                return (
                  ...
                  >
                    ...
                    </StyledTableCell>
                    {
                      selectedColumns?.filter(c=>c?.id !== 'action')?.map((column, index) => {
                        return <StyledTableCell
                          ...
                          key={index}
                          onClick={()=> {if(!column?.disableClickDetail) navigate(`/online/informatique/logiciels/details/${row?.id}`)}}
                        >
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/informatique/logiciels/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/informatique/logiciels/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
