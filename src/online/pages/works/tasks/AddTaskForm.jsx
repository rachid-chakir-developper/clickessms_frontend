        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          >
            ...
            <Grid xs={2} sm={4} md={4} item>
              ...
              <Item>
                <TheAutocomplete
                  options={clientsData?.clients?.nodes}
                  label="Client"
              ...
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Réference client de l'intervention"
                  value={formik.values.clientTaskNumber}
                  onChange={(e) =>
                    formik.setFieldValue('clientTaskNumber', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={4} md={4} item>
              ...
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Nom de donneur d'ordre"
                  value={formik.values.contractorName}
                  onChange={(e) =>
                    formik.setFieldValue('contractorName', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Tél. de donneur d'ordre"
                  value={formik.values.contractorTel}
                  onChange={(e) =>
                    formik.setFieldValue('contractorTel', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="email de donneur d'ordre"
                  value={formik.values.contractorEmail}
                  onChange={(e) =>
                    formik.setFieldValue('contractorEmail', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={4} md={4} item>
              ...
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Nom de la personne sur place"
                  value={formik.values.receiverName}
                  onChange={(e) =>
                    formik.setFieldValue('receiverName', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Tél. de la personne sur place"
                  value={formik.values.receiverTel}
                  onChange={(e) =>
                    formik.setFieldValue('receiverTel', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Email de la personne sur place"
                  value={formik.values.receiverEmail}
                  onChange={(e) =>
                    formik.setFieldValue('receiverEmail', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Nom de propriétaire de chantier"
                  value={formik.values.siteOwnerName}
                  onChange={(e) =>
                    formik.setFieldValue('siteOwnerName', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Nom de locataire de chantier"
                  value={formik.values.siteTenantName}
                  onChange={(e) =>
                    formik.setFieldValue('siteTenantName', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={4} md={4} item>
              ...
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Infos intérvenants"
                  multiline
                  rows={6}
                  value={formik.values.workersInfos}
                  onChange={(e) =>
                    formik.setFieldValue('workersInfos', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={4} md={4} item>
              ...
              <Item>
                <TheAutocomplete
                  ...
                  onChange={(e, newValue) =>
                    formik.setFieldValue('vehicles', newValue)
                  }
                />
              </Item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Infos véhicules"
                  multiline
                  rows={6}
                  value={formik.values.vehiclesInfos}
                  onChange={(e) =>
                    formik.setFieldValue('vehiclesInfos', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={4} md={4} item>
              ...
              <Item>
                <TheAutocomplete
                  options={materialsData?.materials?.nodes}
                  label="Matérials"
                  placeholder="Ajouter un matérial"
                  limitTags={2}
                  value={formik.values.materials}
                  onChange={(e, newValue) =>
                    formik.setFieldValue('materials', newValue)
                  }
                />
              </Item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Infos matérials"
                  multiline
                  rows={6}
                  value={formik.values.materialsInfos}
                  onChange={(e) =>
                    formik.setFieldValue('materialsInfos', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={12} sm={12} md={12} item>
              ...
              <Item>
                <TheSwitch
                  variant="outlined"
                  label="Utiliser le Devis"
                  checked={formik.values.isFromQuote}
                  value={formik.values.isFromQuote}
                  onChange={(e) =>
                    formik.setFieldValue('isFromQuote', e.target.checked)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={12} sm={6} md={6} item>
              <Item>
                <TheTextField
                  variant="outlined"
                  label="Commentaire pour l'inérvention"
                  multiline
                  rows={6}
            ...
            <Grid xs={2} sm={3} md={3} item>
              <Item>
                <TheTextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue('totalPriceHt', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={3} md={3} item>
              <Item>
                <TheTextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue('totalPriceTtc', e.target.value)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
            ...
            <Grid xs={2} sm={2} md={2} item>
              <Item>
                <TheSwitch
                  variant="outlined"
                  label="Afficher pour le client"
                  checked={formik.values.isDisplayPrice}
                  value={formik.values.isDisplayPrice}
                  onChange={(e) =>
                    formik.setFieldValue('isDisplayPrice', e.target.checked)
                  }
                  disabled={loadingPost || loadingPut}
                />
              </Item>
