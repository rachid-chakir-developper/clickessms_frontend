...
function EnhancedTableToolbar(props) {
  ...
  return (
    ...
    >
      {numSelected > 0 ? (
      ...
      ) : (<Box sx={{ flex: '1 1 100%', paddingBottom: 2 }}>
        <Typography
          sx={{ flex: '1 1 100%' }}
          variant="h6"
          id="tableTitle"
        ...
        <Typography
          ...
          sx={{fontSize: 14}}
        >
          Aidez-nous à améliorer l'application en partageant vos retours, suggestions ou en signalant des corrections.
        </Typography>
      </Box>
      )}
...
export default function TableListFeedbacks({
  loading,
  rows,
  onDeleteFeedback,
              ...
              {visibleRows?.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <StyledTableCell align="left"
                      onClick={()=> navigate(`/online/roberp/feedbacks/details/${row?.id}`)}>
                      {getFeedbackModuleLabel(row?.feedbackModule)}
                    </StyledTableCell>
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/roberp/feedbacks/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/roberp/feedbacks/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
