...
export default function PartnerDetails() {
  ...
  const [getPartner, { loading : loadingPartner, data: partnerData }] = useLazyQuery(GET_PARTNER)
React.useEffect(()=>{
    if(idPartner){
  ...
  return (
    <Stack>
        {partnerData?.partner && <PartnerDetailsPage partner={partnerData?.partner} />}
    </Stack>
  );
}
        ...
        >
          ...
          >
            ...
            >
              ...
              {partnerType && partnerType!=='' && <Typography variant="body2">
                Type: 
