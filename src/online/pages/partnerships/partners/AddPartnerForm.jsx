...
import { POST_PARTNER, PUT_PARTNER } from '../../../../_shared/graphql/mutations/PartnerMutations';
...
export default function AddPartnerForm({ idPartner, title}) {
    ...
    const formik = useFormik({
        initialValues: {
            photo : undefined, coverImage : undefined, number : '', name : '', managerName : '' ,
            city : '' , zipCode : '' , address : '' , mobile : '' , fix : '' , fax : '' ,
            email : '' , webSite : '' , otherContacts : '' ,
            iban : '' , bic : '' , bankName : '' ,
            isActive : true , description : '' , observation : '' , partnerType : 'INDIVIDUAL'
          },
              ...
              fields: {
                partners(existingPartners = { totalCount: 0, nodes: [] }, { readField }) {
                    ...
                    const updatedPartners = existingPartners.nodes.map((partner) =>
                        readField('id', partner) === updatedPartner.id ? updatedPartner : partner
                    );
                    ...
                    <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                            ...
                            <Item>
                                <FormControl fullWidth>
                                    ...
                                    <Select
                                        ...
                                        onChange={(e) => formik.setFieldValue('partnerType', e.target.value)}
                                        disabled={loadingPost || loadingPut}
                                    >
                        ...
                        <Grid xs={12} sm={12} md={12}>
                            <Item sx={{ justifyContent: 'end', flexDirection : 'row' }}>
                                <Link to="/online/partenariats/partenaires/liste" className="no_style">
