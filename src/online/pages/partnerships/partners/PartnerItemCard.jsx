...
export default function PartnerItemCard({partner, onDeletePartner, onUpdatePartnerState }) {
      ...
      <Stack direction="column" spacing={2} alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Tooltip title="Modifier">
            <Link to={`/online/partenariats/partenaires/modifier/${partner?.id}`} className="no_style">
              <IconButton aria-label="edit" size="small">
                <Edit fontSize="small" />
              </IconButton>
            </Link>
          </Tooltip>
          {partner?.folder && <Tooltip title="Pièces jointes">
          ...
          <Tooltip title="Détails">
            <Link to={`/online/partenariats/partenaires/details/${partner?.id}`} className="no_style">
              <IconButton aria-label="edit" size="small">
