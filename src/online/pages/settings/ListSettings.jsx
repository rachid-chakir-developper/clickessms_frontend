          ...
          <Item>
            ...
            >
              ...
              <Stack sx={{ alignSelf: 'center', ml: 2, width: '100%' }}>
                ...
                <Link to="/online/parametres/association/modules" className="no_style">
                  <Button variant="outlined">Modifier</Button>
                </Link>
              </Stack>
            </Card>
            ...
            >
              ...
              <Stack sx={{ alignSelf: 'center', ml: 2, width: '100%' }}>
                <Typography
                  ...
                  sx={{ mb: 1 }}
                >
                  Les media et urls de l'association
                </Typography>
                <Link to="/online/parametres/association/medias" className="no_style">
                  <Button variant="outlined">Modifier</Button>
                </Link>
              </Stack>
            </Card>
          ...
          <Item>
            ...
            >
              ...
              <Stack sx={{ alignSelf: 'center', ml: 2, width: '100%' }}>
                ...
                <Link
                  to="/online/parametres/message-notifications"
                  className="no_style"
                >
                  <Button variant="outlined">Gérer</Button>
                </Link>
              </Stack>
            </Card>
          </Item>
          ...
          <Item>
            ...
            >
              ...
              <Stack sx={{ alignSelf: 'center', ml: 2, width: '100%' }}>
                ...
                <Link
                  to="/online/parametres/formulaires-personnalises"
                  className="no_style"
                >
                  <Button variant="outlined">Gérer</Button>
                </Link>
