...
import { getFormatDate, getMessageNotificationTypeLabel } from '../../../../_shared/tools/functions';
...
export default function TableListMessageNotifications({
  loading,
  rows,
                ...
                <StyledTableRow>
                  <StyledTableCell colSpan="7">
                    <Alert severity="warning">
                      Aucun message notification trouvé.
                    </Alert>
                  </StyledTableCell>
                </StyledTableRow>
              )}
                ...
                return (
                  ...
                  >
                    ...
                    <StyledTableCell
                      ...
                      scope="row"
                      padding="none"
                      onClick={()=> navigate(`/online/parametres/message-notifications/details/${row?.id}`)}
                    >
                      <Avatar
                        alt={row?.title}
                        variant="rounded"
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/parametres/message-notifications/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/parametres/message-notifications/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
                        ...
                        <MenuItem
                          onClick={() => {
                            onDeleteMessageNotification(row?.id);
                            handleCloseMenu();
                          }}
                          sx={{ color: 'error.main' }}
                        >
                        ...
                        {onUpdateMessageNotificationState && (
                          <Tooltip title={!row?.isActive ? 'Activer' : 'Désactiver'}>
                            <MenuItem
                              ...
                              onClick={() => {
                                onUpdateMessageNotificationState(row?.id);
                                handleCloseMenu();
                              }}
                            >
                              {!row?.isActive ? (
