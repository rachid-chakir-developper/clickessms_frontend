...
export default function MessageNotificationItemCard({
  ...
  const onGoToDetails = () => {
    navigate(
      `/online/parametres/message-notifications/details/${messageNotification?.id}`,
    );
  };
  return (
      ...
      >
        ...
        >
          ...
          <Tooltip title="Modifier">
            <Link
              to={`/online/parametres/message-notifications/modifier/${messageNotification?.id}`}
              className="no_style"
            >
          ...
          <Tooltip title="Détails">
            <Link
              to={`/online/parametres/message-notifications/details/${messageNotification?.id}`}
              className="no_style"
            >
              <MenuItem onClick={handleCloseMenu}>
