                ...
                return (
                  ...
                  >
                    ...
                    <StyledTableCell
                      ...
                      scope="row"
                      padding="none"
                      onClick={()=> navigate(`/online/cse/articles/details/${row?.id}`)}
                    >
                      <Avatar
                        alt={row?.title}
                        variant="rounded"
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/cse/articles/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/cse/articles/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
