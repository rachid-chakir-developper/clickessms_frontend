...
export default function TableListSceBenefits({
  loading,
  rows,
  onDeleteSceBenefit,
                ...
                return (
                  ...
                  >
                    ...
                    <StyledTableCell
                      ...
                      scope="row"
                      padding="none"
                      onClick={()=> navigate(`/online/cse/avantages/details/${row?.id}`)}
                    >
                       {row?.title}
                    </StyledTableCell>
                    ...
                    <StyledTableCell align="right">
                      ...
                      >
                        <Link
                          to={`/online/cse/avantages/details/${row?.id}`}
                          className="no_style"
                        >
                        ...
                        <Link
                          to={`/online/cse/avantages/modifier/${row?.id}`}
                          className="no_style"
                        >
                          <MenuItem onClick={handleCloseMenu}>
                            <Edit sx={{ mr: 2 }} />
                        ...
                        {onUpdateSceBenefitState && (
                          <Tooltip title={!row?.isActive ? 'Activer' : 'Désactiver'}>
                            <MenuItem
                              ...
                              onClick={() => {
                                onUpdateSceBenefitState(row?.id);
                                handleCloseMenu();
                              }}
                            >
                              {!row?.isActive ? (
