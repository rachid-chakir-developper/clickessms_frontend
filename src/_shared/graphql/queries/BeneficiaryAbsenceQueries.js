...
} from '../fragments/BeneficiaryAbsenceFragment';
...
export const GET_BENEFICIARY_ABSENCES = gql`
  query GetBeneficiaryAbsences(
    $beneficiaryAbsenceFilter: BeneficiaryAbsenceFilterInput
    $offset: Int
    $limit: Int
    $page: Int
  ) {
    beneficiaryAbsences(
      beneficiaryAbsenceFilter: $beneficiaryAbsenceFilter
      offset: $offset
      limit: $limit
      page: $page
    ) {
