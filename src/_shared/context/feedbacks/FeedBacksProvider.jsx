...
const initializerArg = {
    confirmDialog : { isOpen: false, title: 'attention', subTitle: 'Voullez vous vraiment ?' },
    notifyAlert : { isOpen: false, message: 'je teste alert test', type: 'success' },
    dialogListLibrary : { isOpen: false, onClose : ()=>{} , type : null, folderParent : null },
...
export const FeedBacksProvider = ({ children }) => {
  ...
  return (
    <FeedBacksContext.Provider value={{ setNotifyAlert,  setConfirmDialog, setDialogListLibrary, setPrintingModal}}>
        {children}
        <AlertService notify={state?.notifyAlert} 
                        setNotify={setNotifyAlert} />
        <ConfirmDialogService confirmDialog={state?.confirmDialog} 
                                setConfirmDialog={setConfirmDialog} />
        <DialogListLibrary dialogListLibrary={state?.dialogListLibrary} 
                                setDialogListLibrary={setDialogListLibrary} />
        <PrintingModal printingModal={state?.printingModal} 
